...
2) Clone this repository with `git clone https://github.com/Carleton-BIT/BIT2008-useraccounts.git`
3) Open the repository with PyCharm. You can do this by going file->open and selecting the cloned folder called `BIT2008-useraccounts`
4) Configure your project interpreter. Go to file->settings, and selecting Python Interpreter under `Project: BIT2008-useraccounts`, and clicking Add Interpreter->Add Local Interpreter
...
9) In your project folder (BIT2008-useraccounts/studentdemo) create a file called `.env`
...
12) On the terminal, navigate to `BIT2008-useraccounts/studentdemo` and run `python manage.py migrate`
